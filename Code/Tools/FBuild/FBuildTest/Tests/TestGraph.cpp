...
void TestGraph::TestNodeTypes() const
{
    ...
    }
    {
        ...
        Node * n = ng.CreateDLLNode( AStackString<>( "zz.dll" ), libraries, Dependencies(), AString::GetEmpty(), AString::GetEmpty(), AString::GetEmpty(), 0, Dependencies(), Dependencies(), AStackString<>(), nullptr, AString::GetEmpty() );
    ...
    }
    {
        Dependencies libraries( 1, false );
        libraries.Append( Dependency( fn ) );
        Node * n = ng.CreateExeNode( AStackString<>( "zz.exe" ), libraries, Dependencies(), AString::GetEmpty(), AString::GetEmpty(), AString::GetEmpty(), 0, Dependencies(), Dependencies(), AStackString<>(),nullptr, AString::GetEmpty() );
